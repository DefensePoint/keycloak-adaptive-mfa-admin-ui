...
export class Groups extends Resource<{ realm?: string }> {
  // Realm groups are not organization groups. The admin UI calls these to
  // distinguish the realm Groups view from the organization Groups view; the
  // realm resource has no owning organization.
  public isOrgGroups = () => false;
  public getOrgId = (): string | undefined => undefined;
